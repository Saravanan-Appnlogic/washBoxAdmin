...
<!-- Mirrored from beyondadmin-v1.4.2.s3-website-us-east-1.amazonaws.com/tables-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2015 19:39:37 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!--Beyond styles-->
    <link id="beyond-link" href="<?php echo site_url();?>application/assets/css/beyond.min.css" rel="stylesheet" />
    ...
    <!--Page Related styles-->
    <link href="<?php echo site_url();?>application/assets/css/dataTables.bootstrap.css" rel="stylesheet" />
...
<!--    <script src="assets/js/slimscroll/jquery.slimscroll.min.js"></script>-->
    ...
    <script src="<?php echo site_url();?>application/assets/js/datatable/jquery.dataTables.min.js"></script>
   <!-- <script src="assets/js/datatable/ZeroClipboard.js"></script>-->
    <!--<script src="assets/js/datatable/dataTables.tableTools.min.js"></script>-->
    <script src="<?php echo site_url();?>application/assets/js/datatable/dataTables.bootstrap.min.js"></script>
    <script src="<?php echo site_url();?>application/assets/js/datatable/datatables-init.js"></script>
    <script>
